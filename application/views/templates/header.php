      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo base_url(); ?>users/new_user">Create User</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo base_url(); ?>roles">View Roles</a></li>
            <li><a href="<?php echo base_url(); ?>roles/new_role">Create Role</a></li>
          </ul>
        </li>
